...
public class TfActivity extends AppCompatActivity  {
    ...
    TextView questiontv,option1tv,option2tv,timeer,questionCounter;
    Button next,back;
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for (int i = 0; i <  Integer.valueOf(numberQ); i++) {
                        ...
                        Integer[] random = new Integer[]{1, 0};
    ...
    public void onClick(View view) {
        if (option1tv.equals(view) || option2tv.equals(view) ) {
            ...
            if(num < Integer.valueOf(numberQ)) {
                ...
                Intent intent = new Intent(TfActivity.this, ResultActivity.class);
    ...
    String GenrateUrl(String category,String difficulty,String numberQ){
        if (getCategoryValue(category)=="" && getDifficultyValue(difficulty)=="") {
            return "https://opentdb.com/api.php?amount="+numberQ+"&type=boolean";
        }else if(getCategoryValue(category)==""){
            return "https://opentdb.com/api.php?amount="+numberQ+"&difficulty="+getDifficultyValue(difficulty)+"&type=boolean";
        } else if (getDifficultyValue(difficulty)=="") {
            return "https://opentdb.com/api.php?amount="+numberQ+"&category="+getCategoryValue(category)+"&type=boolean";
        }  else {
            return "https://opentdb.com/api.php?amount=" + numberQ + "&category=" + getCategoryValue(category) + "&difficulty=" + getDifficultyValue(difficulty) + "&type=boolean";
        }
